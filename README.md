...
## Project Structure
    ...
    ├── qwertyuykjhtg_dev_41610  # Django project configurations
...
1. Clone this repo and `cd qwertyuykjhtg_dev_41610`
...
2. Clone this repo and `cd qwertyuykjhtg_dev_41610`
